...
app.on('before-quit', () => {
  ...
  // Kill Flask forcefully after a grace period if it's still up. Flask is
  // spawned with detached:false, so it has no separate process group to
  // target with -pid — that attempt always threw ESRCH and silently fell
